...
<head>
    ...
    <title>File and Folder Page</title>
...
<body class="d-flex flex-column min-vh-100">
	<div class="jumbotron bg-cover" style="text-align:center">
        ...
        <p class="lead">You can upload file and create folders here
        <hr class="my-4" style="width:90%;text-align:center;margin-left:8.6%">
