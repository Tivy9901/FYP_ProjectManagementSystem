        ...
        <div class="card">
            <div class="row">
                <div class="col-md-7 px-3">
                    ...
                    <a href="team/index.php" class="mt-auto btn btn-primary">Start Now</a>
                    </div>
                </div>
                <div class="col-md-5">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7 ml-5">
                    <div class="card-body">
                        ...
                        <a href="project/index.php">Read More...</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-md-8 ml-3">
                    <div class="card-body">
                        ...
                        <a href="forum/main.php">Read More...</a>
                    </div>
                </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8 ml-5">
                    <div class="card-body">
                        ...
                        <a href="file/index.php">Read More...</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-md-8 ml-3">
                    <div class="card-body">
                        ...
                        <a href="todo/index.php">Read More...</a>
                    </div>
                </div>
                <div class="col-md-2  mt-2 mb-2" >
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7 ml-5">
                    <div class="card-body">
                        ...
                        <a href="event/main.php">Read More...</a>
                    </div>
                </div>
            </div>
        </div>
